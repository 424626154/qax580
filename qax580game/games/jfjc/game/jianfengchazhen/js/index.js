gameurl = 'http://yx8.com/jianfengchazhen/';
imgUrl = "http://yx8.com/game/jianfengchazhen/icon.png";
...
"undefined" == typeof window.define && (window.define = function() {}, window.define.amd = 1),
    ...
    $AJB.general.Game = function() {
                    ...
                    i.switchStage(0, function() {
                        h.enabled = !1,
                            ...
                            wx.onMenuShareAppMessage({
                                title: "见缝插针，我已玩到第" + D + "关了，你也来试试吧！",
                                desc: "见缝插针，我已玩到第" + D + "关了，你也来试试吧！",
                                link: gameurl,
                                imgUrl: imgUrl,
        ...
        var h, i, j, k = $AJB.general.Scene(),
            ...
            y = 60,
            z = "core-ball-level",
            A = "见缝插针，我已玩到第#{level}关了，你也来试试吧!",
            B = "sinaweibo://share?content=见缝插针，我已玩到第#{level}关了，你也来试试吧！",
            C = m(s),
            D = +o.getValue(z) || 1,
            E = !1,
            F = 0,
...
//    url: encodeURIComponent(window.location.href)
    ...
    wx.ready(function() {
        ...
        // 2.1 监听“分享给朋友”，按钮点击、自定义分享内容及分享结果接口
        wx.onMenuShareAppMessage({
            title: "见缝插针，我已玩到第" + GlobalLevel + "关了，你也来试试吧！",
            desc: "见缝插针，我已玩到第" + GlobalLevel + "关了，你也来试试吧！",
            link: gameurl,
            imgUrl: imgUrl,
            trigger: function(res) {
                // 不要尝试在trigger中使用ajax异步请求修改本次分享的内容，因为客户端分享操作是一个同步操作，这时候使用ajax的回包会还没有返回
