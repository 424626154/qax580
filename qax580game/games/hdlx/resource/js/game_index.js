	...
	function _createTopMenu () {
		...
		if (!_getTopMenu) {
			...
			_getTopMenu.innerHTML = [
				'<span style="position:relative;display:inline-block;width:20%;text-align:left;"><a id="directionMenuBtn_0" href="javascript:void(0);" class="menuBtn2 radius" style="top:-11px;margin-left:5px;"><span id="directionMenuBtn_1" class="menuBtn2-icon"></span><span id="directionMenuBtn_2" class="menuBtn2-desc">yx8.com</span></a></span>',
				'<span style="position:relative;display:inline-block;width:60%;text-align:center;"><a href="http://yx8.com"><img id="directionMenuBtnDuoPao" src="../resource/img/iconmap_topheader.png" /></a></span>',
...
$j(document).ready(function(){
	...
	if (uapp){ //如果是Uapp的话
		...
		//$j("body").append('<div style="display:none;"></div>');
	}
});
